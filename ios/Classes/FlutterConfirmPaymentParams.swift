...
class FlutterConfirmPaymentParams {
    ...
    static func create(request: Dictionary<String, AnyObject?>, card: FlutterCard?, savedCard: FlutterSavedCard?) -> FlutterConfirmPaymentParams {
        ...
        let transactionParams: FlutterTransactionParams  = FlutterTransactionParams(
            orderInfo: transactionParamsJSON["order_info"] as? String, email: transactionParamsJSON["email"] as? String, fullName: transactionParamsJSON["full_name"] as? String, address: transactionParamsJSON["address"] as? String, city: transactionParamsJSON["city"] as? String, zip: transactionParamsJSON["zip"] as? String, phone: transactionParamsJSON["phone"] as? String, country: transactionParamsJSON["country"] as? String, customParams:transactionParamsJSON["custom_params"] as? String
        )
